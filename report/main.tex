...
\iffalse
  ...
  \ccsdesc[500]{Security~Software security}
  \ccsdesc[300]{Security~Buffer Overflow}
  ...
  \keywords{Memory Safety, Rust, Buffer Overflow}
...
% % \input{checker.tex}
% \input{checkerNew.tex}
% \input{temporal_safety.tex}
% \input{validator.tex}
...
% \begin{acks}
%   % I would like to extend my gratitude to my supervisor Dr. Elia Athanasopoulo
%   % for his valuable advice, support, and guidance throughout the entire duration
%   % of this project. His expertise and mentorship were invaluable in helping me
%   % to
%   % achieve my goals and complete this project successfully.
% \end{acks}
